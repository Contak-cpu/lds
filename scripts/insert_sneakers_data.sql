-- Datos de prueba para "Los de Siempre Sneakers" CRM
-- Inserción de categorías de zapatillas
...
-- Inserción de productos (zapatillas)
...
-- Inserción de egresos de prueba
